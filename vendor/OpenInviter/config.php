<?php
	$openinviter_settings=array(
		"username"=>"vsbmeza",
		"private_key"=>"a4eefa4db5b345b33ef111150e063df8",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://meza.hu", // http://meza.hu is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://meza.hu", // http://meza.hu is the website on your account. If wrong, please update your account at OpenInviter.com
