<?php
	$openinviter_settings=array(
		...
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://myixora.com", // http://myixora.com is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to http://myixora.com", // http://myixora.com is the website on your account. If wrong, please update your account at OpenInviter.com
